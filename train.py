...
def do_epoch(args, epoch, net, dataset, optimizer, eval=False):
    ...
    for iter, data in enumerate(dataloader):
        ...
        if eval:
            ...
            vis_res(img[0,:,:,:].permute(1, 2, 0), mask[0,0,:,:], prob, prob>0.5, save_path='./epoch_{}_iter_{}.png'.format(epoch, iter), title=None)
...
def run(args):
    ...
    for epoch in range(args.epoch):
        ...
        torch.save(net.state_dict(), "./model_%d.pt" % epoch)
